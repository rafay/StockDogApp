...
angular.module('stockDogApp')
  .controller('DashboardCtrl', function ($scope, WatchlistService, QuoteService) {
    ...
    var updateCharts = function () {
      ...
      _.each($scope.watchlists, function (watchilst) {
        donutChart.data.push([watchilst.name, watchilst.marketValue]);
        columnChart.data.push([watchilst.name, watchilst.dayChange, watchilst.dayChange < 0 ? 'Red' : 'Green']);
      });
    ...
    //[8] Watch for changes to the watchlists.
